...
$(DIREXE)/mctr_client.exe : $(DIRSYS)/invoke.cpp $(DIRCLI)/mctr_client.cpp
	g++ $(DIRSYS)/invoke.cpp $(DIRSYS)/usercall.cpp $(DIRCLI)/mctr_client.cpp -pthread -o $(DIREXE)/mctr_client.exe $(FLAGOPENCV) 

$(DIREXE)/QTstream.exe : $(DIRSYS)/invoke.cpp $(DIRSERV)/QTstream.cpp
	g++ $(DIRSYS)/invoke.cpp $(DIRSYS)/usercall.cpp $(DIRSERV)/QTstream.cpp -pthread -o $(DIREXE)/QTstream.exe $(FLAGOPENCV) 
